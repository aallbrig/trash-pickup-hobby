...
HEADLESS_MODE=false LANDING_PAGE=${LANDING_PAGE:-"http://localhost:8888"} GAME_URL=${GAME_URL:-"http://localhost:8888/WebGL/index.html"} npm --prefix ./acceptance-tests test
